...
function paintToCanvas() {
  ...
  return setInterval(() => {
    ...
    pixels = rgbSplit(pixels); // SPLIT EFFECT
    // ctx.globalAlpha = 0.03; // GHOSTING EFFECT (also show frames underneath the newest)
    pixels = greenScreen(pixels); // GREEN SCREEN FILTER
